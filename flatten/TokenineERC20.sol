// Root file: contracts/tokens/TokenineERC20.sol
 ...
 * the owner.
 */
abstract contract TOwnable is TContext {
 ...
 */
contract ERC20 is TContext, IERC20 {
    using TSafeMath for uint256;
 ...
 */
abstract contract TPausable is TContext {
    /**
 ...
 */
abstract contract ERC20Pausable is ERC20, TPausable {
    /**
 ...
 */
abstract contract ERC20Burnable is TContext, ERC20 {
    using TSafeMath for uint256;
 ...
 */
abstract contract AccessControl is TContext {
    using EnumerableSet for EnumerableSet.AddressSet;
    using TAddress for address;
 ...
 */
contract TokenineERC20  is ERC20Mintable, ERC20Burnable, TOwnable, Roles, ERC20Pausable {
